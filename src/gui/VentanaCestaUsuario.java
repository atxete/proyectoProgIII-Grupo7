	...
	public VentanaCestaUsuario() {
		...
		*/
		...
		botonPagar.addActionListener((e)->{
			...
			if(!BaseDatos1.obtenerProductosCesta(c1.getCodigoUsuario()).isEmpty() /*!c1.getCesta().isEmpty()*/) {
				...
				for(Producto p : BaseDatos1.obtenerProductosCesta(c1.getCodigoUsuario())/*c1.getCesta()*/) {
				...
				for(Producto p : BaseDatos1.obtenerProductosCesta(c1.getCodigoUsuario()) ) {
